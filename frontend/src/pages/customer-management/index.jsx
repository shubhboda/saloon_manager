...
const CustomerManagement = () => {
  ...
  useEffect(() => {
    ...
    // Listen for add customer event from CustomerFilters
    const handleAddCustomerEvent = () => {
      handleAddCustomer();
    };

    if (typeof window !== 'undefined') {
      window.addEventListener('addCustomer', handleAddCustomerEvent);
    }

    return () => {
      if (typeof window !== 'undefined') {
        window.removeEventListener('addCustomer', handleAddCustomerEvent);
      }
    };
  }, []);
  ...
  const handleSaveCustomer = async (savedCustomer, mode) => {
    if (mode === 'add') {
